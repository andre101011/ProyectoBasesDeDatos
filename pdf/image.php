...
$pdf->Cell(20,5,'ID',1,0); //vertically merged cell, height=2x row height=2x5=10
$pdf->Cell(50,5,'Name',1,0); //vertically merged cell
$pdf->Cell(25,5,'Score',1,0); //normal height, but occupy 4 columns (horizontally merged)
$pdf->Cell(25,5,'Score',1,0); //normal height, but occupy 4 columns (horizontally merged)
$pdf->Cell(25,5,'Score',1,0); //normal height, but occupy 4 columns (horizontally merged)
$pdf->Cell(25,5,'Score',1,0); //normal height, but occupy 4 columns (horizontally merged)
$pdf->Cell(20,5,'Passing',1,0); //vertically merged cell
...
for($i=1;$i<=20;$i++){
	...
	$pdf->Cell(25,5,"aasaaaaaaaaaa",'LR',0);
