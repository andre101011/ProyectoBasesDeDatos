...
$query = "SELECT sala.codigo AS codigoS, 
				mac.codigo AS codigoM,
				mac.modelo 
			FROM sala 
			INNER JOIN mac 
				ON sala.codigo=mac.sala_codigo";
...
$pdf->Cell(40,5,"Codigo MAC",1,0);
$pdf->Cell(40,5,"Modelo MAC",1,0);
...
foreach($data as $item){
	...
	$pdf->Row(Array(
		utf8_decode($item['codigoS']),
		utf8_decode($item['codigoM']),
